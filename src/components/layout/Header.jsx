...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="mx-auto grid h-16 max-w-[90rem] grid-cols-[1fr_auto_1fr] items-center gap-8 px-global">
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="absolute inset-x-0 top-16 border-t border-line bg-bg lg:hidden"
          >
            <div className="mx-auto flex max-w-[90rem] flex-col gap-1 px-global py-6">
              {NAV_LINKS.map((link) => (
                <a
                  key={link.key}
                  href={link.href}
                  className="py-2 font-extrabold text-[1.5rem] uppercase tracking-[-0.01em] text-cream"
